package object scalashop {
  ...
  /*Cuando necesite calcular coordenadas x y y de un pixel, y sea necesario asegurar
   que ellas quedan dentro de los l´ımites de la imagen, puede usar el metodo cercar*/
